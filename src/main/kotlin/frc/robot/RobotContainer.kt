...
class RobotContainer {
        ...
        init {
                ...
                if (!onTest.config) {
                        ...
                        NamedCommands.registerCommand(
                                        "pickup",
                                        Pickup(shooter!!, elevator!!, intake!!, false, false)
                                                        .build()
                        )
                        ...
                        NamedCommands.registerCommand(
                                        "shootSpeaker",
                                        SpeakerShoot(elevator!!, shooter!!, intake!!).build()
                        )
                        //    NamedCommands.registerCommand(
                        //        "shootSpeaker",
        ...
        private fun configureBindings() {
                ...
                if (shooter != null && intake != null && elevator != null) {
                        ...
                        JoystickButton(driverLeftStick, 10)
                                        .whileTrue(AlignSpeaker(aprilCamera, swerveDrive))

                        JoystickButton(driverRightStick, 11)
                                        .onTrue(
                                                        InstantCommand(
                                                                        {
                                                                                shooter!!.startShooting(
                        ...
                        // operatorExtra.rightBumper().toggleOnTrue()//Pickup(shooter!!, elevator!!,
                        // intake!!, true, false).build());
                        operatorExtra.leftBumper()
                                        .whileTrue(
                                                        Shoot(
                                                                                        shooter!!,
                                                                                        elevator!!,
                        ...
                        operatorExtra.rightTrigger(0.5)
                                        .whileTrue(
                                                        SpeakerShoot(
                                                                                        elevator!!,
                                                                                        shooter!!,
                        ...
                        JoystickButton(operatorExtraHid, 9)
                                        .whileTrue(
                                                        shooter!!.backButton()
                                                                        .alongWith(
                                                                                        intake!!.backButton()
                        ...
                        operatorExtra.b()
                                        .onTrue(
                                                        GotoPoseParAmp(shooter!!, elevator!!)
                                                                        .alongWith(
                                                                                        Commands.startEnd(
                                                                                                        object :
                                                                                                                        Runnable {
                        ...
                        JoystickButton(operatorExtraHid, 10).whileTrue(shooter!!.forwardButton())

                        JoystickButton(driverLeftStick, 5)
                                        .toggleOnTrue(Climb(elevator!!, shooter!!).build())
                        JoystickButton(driverLeftStick, 6)
                                        .onTrue(
                                                        Commands.sequence(
                        ...
                        JoystickButton(driverRightStick, 6)
                                        .whileTrue(SetValue.setShootingAngle(shooter!!, 0.0))

                        //            JoystickButton(driverLeftStick, 5)
                        //                    .whileTrue(SetValue.setShootingAngle(shooter!!,
                        // Math.PI * 55 /
                        // 180))
                        ...
                        //     operatorExtra.y().onTrue(GotoPosePar(shooter!!, elevator!!,
                        // Constants.Poses.trapShot)
                        //         .alongWith(
                        //                 InstantCommand(
                        //                         object : Runnable {
                        //                             override fun run() {
                        ...
                        //     operatorExtra.rightTrigger(0.5).onTrue(Shoot(shooter!!, elevator!!,
                        // Shooter.ShootSpeed.Trap).build());
        ...
        fun teleperiodic() {
                ...
                //         if(Math.sqrt(Math.pow(speeds.vxMetersPerSecond, 2.0) +
                // Math.pow(speeds.vyMetersPerSecond, 2.0)) < 0.1
                //         && shooter!!.atAngle()
                //         && driverLeftStick.getRawButton(2))
                //         {0.5} else {0.0})
                SmartDashboard.putNumber(
                                "is apriltag camera present",
        ...
        fun cleanUp() {
                driverExtraHid.setRumble(GenericHID.RumbleType.kBothRumble, 0.0)
                operatorExtraHid.setRumble(GenericHID.RumbleType.kBothRumble, 0.0)
        }
        ...
        val autonomousCommand: Command
                get() {
                        ...
                        //        return SequentialCommandGroup(Shoot(shooter!!).build(),RunAuto("4
                        // piece Inner"));
                        //                        return
                        // ParallelRaceGroup(SequentialCommandGroup(WaitUntilCommand { ->
                        //                            frontNoteCamera.latestResult.hasTargets() ||
                        // backNoteCamera.latestResult.hasTargets()
                        //                        },
                        //                            CollectNote(
                        //                                        PIDConstants(0.045, 0.0,
                        // 0.001000),
                        //                                        frontNoteCamera,
                        //                                        backNoteCamera,
                        //                                        swerveDrive,
                        //                                        10)), Pickup(shooter!!,
                        // elevator!!, intake!!, false, false).build())
                }
}
